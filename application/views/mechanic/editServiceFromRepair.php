...
<section id="main-content">
	<section class="wrapper">
		...
		<div class="row">
			<div class="col-lg-8">
				<h3  class="page-header"><i class="fa fa-plus "></i><i class="fa fa-wrench "></i>Edytuj naprawę w zleceniu</h3>
				<br>
				<?php  echo form_open("mechanic/editServiceFromRepair".'/'.$this->uri->segment(3),array('class'=>'form-horizontal'));?>
            ...
            <div class="form-group">
              <div class="col-lg-12">
                <div class="row">
                  <div class="col-lg-4"> </div>
                  <button type="submit" class="btn btn-primary col-lg-6">Edytuj usługę</button>

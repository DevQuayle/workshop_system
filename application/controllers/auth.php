...
class Auth extends CI_Controller {
	...
	function activate($id, $code=false)
	{
		...
		if ($activation)
		{
			...
			$this->session->set_flashdata('message', $this->ion_auth->messages());
			redirect("admin/showAllMechanics", 'refresh');
		}
		else
		{
			redirect('admin/noAccess','refresh');
	...
	function create_user()
	{
		...
		if ($this->form_validation->run() == true)
		{
			$username = strtolower($this->input->post('username')) ;//. ' ' . strtolower($this->input->post('last_name'));
		...
		else
		{
			...
			$this->load->view('template/header');
			$this->load->view('admin/navigation');
			$this->_render_page('admin/addMechanic', $this->data);
			$this->load->view('template/footer');
	
			//$this->_render_page('admin/addMechanic', $this->data);
			//redirect('admin/addMechanic','refresh');
		}
		}	
	...
	function edit_user($id)
	{
		...
		$this->data['password_confirm'] = array(
			...
			$this->load->view('template/header');
			$this->load->view('admin/navigation');
		$this->_render_page('admin/editMechanic', $this->data);
		$this->load->view('template/footer');
	}
